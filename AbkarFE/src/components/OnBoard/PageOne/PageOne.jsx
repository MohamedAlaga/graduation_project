      ...
      <div className={`${style.layer}`}>
        ...
        <div className="3bkr  w-100 mb-5 ">
          <div className={`${style.head} `}>
            <div
              onClick={toSetting}
              className={`${style.editIcon} d-flex flex-column align-items-center`}
            >
              <svg
                width="44"
                height="44"
            ...
            <div className="position-relative">
              ...
              >
                <path
                  d="M24.7891 4L4 20.4445L24.7891 36.889M125.211 36.889L146 20.4445L125.211 4"
                  stroke="black"
                  strokeWidth="8"
                  strokeLinecap="round"
        ...
        <div className="container text-center ">
          ...
          <p className={`${style.computerParagraph}  mt-5 mb-4 `}>
            هو كــورس عن تـاريخ الكمبيوتر بشكل بـســيط وممتع، يقدمه لكم ثمانية
            أصدقاء مبرمجين
          </p>
          <p className={`${style.computerParagraph2}`}>🌟 فصول الكورس 🌟</p>
          <div
            className={`${style.direction} row d-flex justify-content-center mb-3 `}
          >
            <div className="col-md-6">
              <p className={`${style.rowparagraph} mb-4 `}>
                {" "}
                ⭐ شرح مكونات الكمبيوتر ونظام التشغيل{" "}
              </p>
              <p className={`${style.rowparagraph} mb-4`}>
                {" "}
                ⭐شرح الانترنت والشبكات والفرق بينهم{" "}
              </p>
              <p className={`${style.rowparagraph} mb-4`}>
                {" "}
                ⭐ كيف تبحث عن حلول فعالة للمشكلات{" "}
              </p>
              <p className={`${style.rowparagraph} mb-4 `}>
                {" "}
                ⭐ تمهيد لمنهج المستوى الثاني من الكورس{" "}
              </p>
            </div>
            <div className="col-md-6 ">
              <p className={`${style.rowparagraph2} ms-md-4 mb-4`}>
                {" "}
                ⭐مراجعة ممتعة عن تطور التكنولوجيا{" "}
              </p>
              <p className={`${style.rowparagraph2} mb-4`}>
                ⭐ شرح واجهة الكمبيوتر وكيفية التحكم به{" "}
              </p>
              <p className={`${style.rowparagraph2} ms-md-2 mb-4 `}>
                {" "}
                ⭐ خطر الانترنت وكيفية حماية نفسك منه{" "}
              </p>
              <p className={`${style.rowparagraph2} mb-4`}>
                {" "}
                ⭐ مقدمة عن البرمجة الحديثة وأساسياتها{" "}
              </p>
            </div>
          </div>
